...
public final class BowConfigRegistry {
    ...
    private static final List<ConfigEntry<?>> ENTRIES = List.of(
            ...
            new ConfigEntry<>("burnt_relic", BurntRelicBowConfig.class, BurntRelicBowConfig::new),
            new ConfigEntry<>("crimson_nexus", CrimsonNexusBowConfig.class, CrimsonNexusBowConfig::new),
            ...
            new ConfigEntry<>("gravewire_bow", GravewireBowConfig.class, GravewireBowConfig::new),
            ...
            new ConfigEntry<>("scatter_bow", ScatterBowConfig.class, ScatterBowConfig::new),
            ...
            new ConfigEntry<>("demons_grasp", DemonsGraspBowConfig.class, DemonsGraspBowConfig::new),
            new ConfigEntry<>("spectral_whisper", SpectralWhisperBowConfig.class, SpectralWhisperBowConfig::new),
            new ConfigEntry<>("soulhoard_bow", SoulhoardBowConfig.class, SoulhoardBowConfig::new),
            ...
            new ConfigEntry<>("twin_shadows", TwinShadowsBowConfig.class, TwinShadowsBowConfig::new),
            new ConfigEntry<>("verdant_vigor", VerdantVigorBowConfig.class, VerdantVigorBowConfig::new),
            new ConfigEntry<>("vaultpiercer", VaultpiercerBowConfig.class, VaultpiercerBowConfig::new),

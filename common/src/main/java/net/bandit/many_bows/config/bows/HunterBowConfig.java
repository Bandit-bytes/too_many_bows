...
public class HunterBowConfig {
    ...
    // Trigger rules
    public transient boolean require_player_owner = true;
    public boolean require_killing_blow = true;

    // Supported mobs
    public transient boolean affect_cows = true;
    public transient boolean affect_pigs = true;
    public transient boolean affect_sheep = true;
    public transient boolean affect_chickens = true;
    public transient boolean affect_rabbits = true;
    ...
    public transient boolean sheep_drop_wool_if_unsheared = true;

    public int chicken_meat_min = 1;
    public int chicken_meat_max = 1;
    public transient int chicken_feather_min = 0;
    public transient int chicken_feather_max = 2;

    public int rabbit_meat_min = 1;
    public int rabbit_meat_max = 2;
    public transient int rabbit_hide_min = 0;
    public transient int rabbit_hide_max = 1;

...
public class NecroFlameBowConfig {
    ...
    public boolean discard_on_block_hit = false;
    ...
    public boolean remove_regeneration = true;
    public boolean remove_instant_health = true;
    public boolean apply_cursed_flame = true;
    ...
    public int trail_particle_duration_ticks = 100;

    public boolean impact_soul_particles_enabled = true;
    public int impact_soul_particle_count = 30;

    public boolean impact_flame_particles_enabled = true;
    public int impact_flame_particle_count = 30;

    public float block_impact_sound_volume = 1.0F;
    public float block_impact_sound_pitch = 1.0F;

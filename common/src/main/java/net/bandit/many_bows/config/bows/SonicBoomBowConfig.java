...
public class SonicBoomBowConfig {
    ...
    public transient int max_lifetime_ticks = 60;
    ...
    // Beam visuals
    public transient boolean beam_particles_enabled = true;
    public transient double beam_length = 2.6D;
    public transient double beam_step = 0.35D;

    // Spiral visuals
    public transient boolean spiral_particles_enabled = true;
    public transient int spiral_particle_count = 18;
    public transient double spiral_start_radius = 0.25D;
    public transient double spiral_expansion_rate = 0.06D;

...
public class SpectralWhisperBowConfig {
    ...
    public transient int max_lifetime_ticks = 140;
    ...
    public transient boolean stop_when_out_of_phases = true;
    public transient boolean discard_when_out_of_phases = false;

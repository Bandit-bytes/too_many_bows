...
//                            } else {
//                                arrow = new ShulkerBlastProjectile(serverLevel, player, bowStack, projectileStack);
//                                if (arrow instanceof ShulkerBlastProjectile shulkerBlastProjectile) {
...
//                                            shulkerBlastProjectile.setBaseDamage(damage / 2);
//                                        }
//                                    }
//                                    shulkerBlastProjectile.setPowerMultiplier(power);
//                                }
//                            }
//
...
//            tooltipComponents.add(Component.translatable("item.too_many_bows.shulker_blast_bow.tooltip").withStyle(ChatFormatting.GOLD));
//            tooltipComponents.add(Component.translatable("item.too_many_bows.shulker_blast_bow.shift_title").withStyle(ChatFormatting.YELLOW));
//            tooltipComponents.add(Component.translatable("item.too_many_bows.shulker_blast_bow.effect1"));
//        } else {

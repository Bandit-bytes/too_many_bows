...
public class VitalityWeaverBow extends BowItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("item.too_many_bows.vitality_weaver").withStyle(ChatFormatting.GOLD));
        tooltipComponents.add(Component.translatable("item.too_many_bows.vitality_weaver.tooltip").withStyle(ChatFormatting.GREEN));
        tooltipComponents.add(Component.translatable("item.too_many_bows.vitality_weaver.details").withStyle(ChatFormatting.YELLOW));
        } else {

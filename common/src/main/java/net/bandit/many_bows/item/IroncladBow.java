...
//
//public class IroncladBow extends ModBowItem {
//
...
//                            } else {
//                                arrow = new IronCladArrow(serverLevel, player, bowStack, projectileStack);
//                                if (arrow instanceof IronCladArrow ironCladArrow) {
...
//                                            ironCladArrow.setBaseDamage(damage / 2);
//                                        }
//                                    }
//                                }
//                            }
...
//            tooltipComponents.add(Component.translatable("item.too_many_bows.ironclad_bow.tooltip").withStyle(ChatFormatting.GRAY));
//            tooltipComponents.add(Component.translatable("item.too_many_bows.ironclad_bow.tooltip.ability").withStyle(ChatFormatting.DARK_PURPLE));
//            tooltipComponents.add(Component.translatable("item.too_many_bows.ironclad_bow.tooltip.legend").withStyle(ChatFormatting.GOLD, ChatFormatting.ITALIC));
//        } else {

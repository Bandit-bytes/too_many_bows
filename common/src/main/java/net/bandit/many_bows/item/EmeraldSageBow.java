...
//
//public class EmeraldSageBow extends ModBowItem {
//
...
//                            } else {
//                                arrow = new HunterXPArrow(serverLevel, player, bowStack, projectileStack);
//                                if (arrow instanceof HunterXPArrow hunterXPArrow) {
...
//                                            hunterXPArrow.setBaseDamage(damage / 1.5);
//                                        }
//                                    }
//                                }
//                            }
...
//            tooltipComponents.add(Component.translatable("item.too_many_bows.emerald_sage_bow").withStyle(ChatFormatting.GREEN));
//            tooltipComponents.add(Component.translatable("item.too_many_bows.emerald_sage_bow.tooltip").withStyle(ChatFormatting.DARK_GREEN));
//        } else {

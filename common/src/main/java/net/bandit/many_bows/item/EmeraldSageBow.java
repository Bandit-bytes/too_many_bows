...
public class EmeraldSageBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level,
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new HunterXPArrow(level, shooter, weaponStack, ammoStack);
        }
    ...
    public void appendHoverText(ItemStack stack,
        ...
        if (isShiftDownSafe()) {
            tooltip.accept(Component.translatable("item.too_many_bows.emerald_sage_bow")
                    .withStyle(ChatFormatting.GREEN));
            tooltip.accept(Component.translatable("item.too_many_bows.emerald_sage_bow.tooltip")

...
//                            } else {
//                                arrow = new DragonsBreathArrow(serverLevel, player, bowStack, projectileStack);
//                                if (arrow instanceof DragonsBreathArrow dragonsArrow) {
...
//                                            dragonsArrow.setBaseDamage(damage / 2.5F);
//                                        }
//                                    }
//                                    dragonsArrow.setPowerMultiplier(power);
//                                }
//
//                            }
//
...
//        tooltipComponents.add(Component.translatable("item.many_bows.dragons_breath_bow.tooltip").withStyle(ChatFormatting.DARK_PURPLE, ChatFormatting.BOLD));
//        tooltipComponents.add(Component.translatable("item.many_bows.dragons_breath_bow.tooltip.ability")

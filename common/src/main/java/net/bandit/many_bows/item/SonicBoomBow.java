...
public class SonicBoomBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level,
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new SonicBoomProjectile(level, shooter, weaponStack, ammoStack);
        }
    ...
    protected void shootProjectile(LivingEntity shooter,
        ...
        if (projectile instanceof SonicBoomProjectile boom) {
            float power = Math.min(1.0F, velocity / 2.5F);
            boom.setPowerMultiplier(power);
        }
    ...
    public void appendHoverText(ItemStack stack,
        ...
        if (isShiftDownSafe()) {
            tooltip.accept(Component.translatable("item.too_many_bows.sonic_bow.tooltip.ability")
                    .withStyle(ChatFormatting.AQUA));
            tooltip.accept(Component.translatable("item.too_many_bows.sonic_bow.tooltip.legend")
                    .withStyle(ChatFormatting.DARK_PURPLE, ChatFormatting.ITALIC));
        } else {
            tooltip.accept(Component.translatable("item.too_many_bows.sonic_bow.tooltip")

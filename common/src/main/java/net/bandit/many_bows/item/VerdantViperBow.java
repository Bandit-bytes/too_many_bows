...
public class VerdantViperBow extends BowItem {
                    ...
                    if (!projectiles.isEmpty() && level instanceof ServerLevel serverLevel) {
                        for (ItemStack projectileStack : projectiles) {
                            ...
                            if (projectileStack.is(Items.SPECTRAL_ARROW) || projectileStack.is(Items.TIPPED_ARROW)) {
                                ...
                                arrow = new VenomArrow(serverLevel, player, bowStack, projectileStack);
                                if (arrow instanceof VenomArrow venomArrow) {
                                    ...
                                    if (rangedDamageAttr != null) {
                                        ...
                                        if (attrInstance != null) {
                                            ...
                                            venomArrow.setBaseDamage(damage / 2.25);
                                        }
                                    }
                                }
                            }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("item.too_many_bows.verdant_viper_bow.tooltip").withStyle(ChatFormatting.GOLD));
        tooltipComponents.add(Component.translatable("item.too_many_bows.verdant_viper_bow.tooltip.ability").withStyle(ChatFormatting.GREEN));
        tooltipComponents.add(Component.translatable("item.too_many_bows.verdant_viper_bow.tooltip.legend").withStyle(ChatFormatting.DARK_GREEN, ChatFormatting.ITALIC));
    }else {

...
public class BeaconBeamBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level, LivingEntity shooter, ItemStack weaponStack, ItemStack ammoStack, boolean crit) {
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new BeaconBeamArrow(level, shooter, weaponStack, ammoStack);
        }
    ...
    public void appendHoverText(ItemStack stack,
                                ...
                                TooltipFlag flag) {
        if (isShiftDownSafe()) {
            tooltip.accept(Component.translatable("item.too_many_bows.beacon_beam_bow.tooltip")
                    .withStyle(ChatFormatting.AQUA));
            tooltip.accept(Component.translatable("item.too_many_bows.beacon_beam_bow.tooltip.ability")
                    .withStyle(ChatFormatting.GRAY));
            tooltip.accept(Component.translatable("item.too_many_bows.beacon_beam_bow.tooltip.legend")

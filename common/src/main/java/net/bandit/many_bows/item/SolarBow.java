...
public class SolarBow extends BowItem {
            ...
            if (!arrowStack.isEmpty() || player.getAbilities().instabuild) {
                ...
                if (power >= 0.1F) {
                    ...
                    level.playSound(null, player.getX(), player.getY(), player.getZ(),
                            SoundEvents.BLAZE_HURT, SoundSource.PLAYERS, 0.5F, 0.6F);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("item.many_bows.solar_bow.tooltip").withStyle(ChatFormatting.GOLD, ChatFormatting.BOLD));
        tooltipComponents.add(Component.translatable("item.many_bows.solar_bow.tooltip.ability")

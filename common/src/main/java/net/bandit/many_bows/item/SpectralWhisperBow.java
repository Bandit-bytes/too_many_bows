...
//                            } else {
//                                arrow = new SpectralArrow(serverLevel, player, bowStack, projectileStack);
...
//                                            spectralArrow.setBaseDamage(damage * 1.16F * power);
//                                        }
//                                    }
//                                }
//                            }
...
//        tooltipComponents.add(Component.translatable("item.too_many_bows.spectral_whisper").withStyle(ChatFormatting.AQUA));
//        tooltipComponents.add(Component.translatable("item.too_many_bows.spectral_whisper.tooltip").withStyle(ChatFormatting.GRAY));
//        tooltipComponents.add(Component.translatable("item.too_many_bows.spectral_whisper.details").withStyle(ChatFormatting.DARK_PURPLE));
//        } else {

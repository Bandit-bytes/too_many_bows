...
public class IcicleJavelinBow extends BowItem {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        if (Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("item.many_bows.icicle_javelin_bow.tooltip").withStyle(ChatFormatting.AQUA));
            tooltipComponents.add(Component.translatable("item.many_bows.icicle_javelin_bow.tooltip.ability").withStyle(ChatFormatting.DARK_AQUA));
            tooltipComponents.add(Component.translatable("item.many_bows.icicle_javelin_bow.tooltip.freeze").withStyle(ChatFormatting.BLUE));
    }else {

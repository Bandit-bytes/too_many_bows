...
public class IcicleJavelinBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level, LivingEntity shooter, ItemStack weaponStack, ItemStack ammoStack, boolean crit) {
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new IcicleJavelin(level, shooter, weaponStack, ammoStack);
        ...
        // ✅ Match AethersCall enchant handling
        if (level instanceof ServerLevel serverLevel) {
    ...
    public void appendHoverText(ItemStack stack,
        ...
        if (isShiftDownSafe()) {
            tooltip.accept(Component.translatable("item.many_bows.icicle_javelin_bow.tooltip")
                    .withStyle(ChatFormatting.AQUA));
            tooltip.accept(Component.translatable("item.many_bows.icicle_javelin_bow.tooltip.ability")
                    .withStyle(ChatFormatting.DARK_AQUA));
            tooltip.accept(Component.translatable("item.many_bows.icicle_javelin_bow.tooltip.freeze")

...
public class TidalBow extends ModBowItem {
                    ...
                    if (!projectiles.isEmpty() && level instanceof ServerLevel serverLevel) {
                        for (ItemStack projectileStack : projectiles) {
                            ...
                            if (projectileStack.is(Items.SPECTRAL_ARROW) || projectileStack.is(Items.TIPPED_ARROW)) {
                                ...
                                arrow = new TidalArrow(serverLevel, player, bowStack, projectileStack);
                                if (arrow instanceof TidalArrow tidalArrow) {
                                    ...
                                    if (rangedDamageAttr != null) {
                                        ...
                                        if (attrInstance != null) {
                                            ...
                                            tidalArrow.setBaseDamage(damage / 2.5);
                                        }
                                    }
                                }
                            }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(Component.translatable("item.too_many_bows.tidal_bow.tooltip").withStyle(ChatFormatting.AQUA));
        tooltipComponents.add(Component.translatable("item.too_many_bows.tidal_bow.tooltip.ability").withStyle(ChatFormatting.DARK_AQUA));
        tooltipComponents.add(Component.translatable("item.too_many_bows.tidal_bow.tooltip.legend").withStyle(ChatFormatting.BLUE, ChatFormatting.ITALIC));
    }else {

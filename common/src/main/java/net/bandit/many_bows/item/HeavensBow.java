...
public class HeavensBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level, LivingEntity shooter, ItemStack weaponStack, ItemStack ammoStack, boolean crit) {
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new LightningArrow(level, shooter, weaponStack, ammoStack);
        }
    ...
    public void appendHoverText(ItemStack stack,
        ...
        if (Minecraft.getInstance().hasShiftDown()) {
            tooltip.accept(Component.translatable("item.too_many_bows.arc_heavens.tooltip").withStyle(ChatFormatting.GOLD));
            tooltip.accept(Component.translatable("item.too_many_bows.arc_heavens.tooltip.ability").withStyle(ChatFormatting.DARK_GREEN));
        } else {

...
public class AncientSageBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level, LivingEntity shooter, ItemStack weaponStack, ItemStack ammoStack, boolean crit) {
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new AncientSageArrow(level, shooter, weaponStack, ammoStack);
        }
    ...
    public void appendHoverText(ItemStack stack,
        ...
        if (isShiftDownSafe()) {
            tooltip.accept(Component.translatable("item.many_bows.ancient_sage_bow.tooltip")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.accept(Component.translatable("item.many_bows.ancient_sage_bow.tooltip.ability")
                    .withStyle(ChatFormatting.DARK_GREEN));
            tooltip.accept(Component.translatable("item.many_bows.ancient_sage_bow.tooltip.legend")

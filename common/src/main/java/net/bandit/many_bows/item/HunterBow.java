...
public class HunterBow extends ModBowItem {
    ...
    protected Projectile createProjectile(Level level, LivingEntity shooter, ItemStack weaponStack, ItemStack ammoStack, boolean crit) {
        ...
        if (ammoItem instanceof ArrowItem arrowItem
            ...
            arrow = new HunterArrow(level, shooter, weaponStack, ammoStack);
            ...
            if (shooter instanceof Player player) {
                ...
                if (rangedDamageAttr != null) {
                    ...
                    if (attrInstance != null) {
                        ...
                        arrow.setBaseDamage(damage / 1.75F);
                    }
                }
            }
        }
    ...
    public void appendHoverText(ItemStack stack,
        ...
        if (isShiftDownSafe()) {
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.shift_title")
                    .withStyle(ChatFormatting.YELLOW));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.mob1")
                    .withStyle(ChatFormatting.GREEN));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.mob2")
                    .withStyle(ChatFormatting.GREEN));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.mob3")
                    .withStyle(ChatFormatting.GREEN));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.mob4")
                    .withStyle(ChatFormatting.GREEN));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.mob5")
                    .withStyle(ChatFormatting.GREEN));
        } else {
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow_bow")
                    .withStyle(ChatFormatting.GOLD));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.tooltip")
                    .withStyle(ChatFormatting.GREEN));
            tooltip.accept(Component.translatable("item.too_many_bows.hunter_bow.hold_shift")

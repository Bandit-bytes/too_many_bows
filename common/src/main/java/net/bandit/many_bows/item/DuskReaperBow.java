...
//                                } else {
//                                    arrow = new DuskReaperArrow(serverLevel, player, bowStack, projectileStack);
//                                    if (arrow instanceof DuskReaperArrow duskReaperArrow) {
...
//                                                duskReaperArrow.setBaseDamage(damage / 2);
//                                            }
//                                        }
//                                        duskReaperArrow.setPowerMultiplier(power);
//                                    }
//                                }
//
//                                // Apply Enchantments
...
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.info").withStyle(ChatFormatting.DARK_PURPLE));
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.soul_fragments").withStyle(ChatFormatting.GRAY));
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.mark").withStyle(ChatFormatting.RED));
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.spectral").withStyle(ChatFormatting.DARK_AQUA));
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.effect").withStyle(ChatFormatting.GOLD));
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.debuff").withStyle(ChatFormatting.DARK_RED));
//            tooltipComponents.add(Component.translatable("item.many_bows.dusk_reaper.tooltip.glow").withStyle(ChatFormatting.LIGHT_PURPLE));
//        } else {

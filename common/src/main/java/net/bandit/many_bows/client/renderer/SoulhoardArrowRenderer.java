...
public class SoulhoardArrowRenderer extends ArrowRenderer<SoulhoardArrow, ArrowRenderState> {

    private static final Identifier TEXTURE =
            Identifier.fromNamespaceAndPath(ManyBowsMod.MOD_ID, "textures/entity/soulhoard_arrow.png");

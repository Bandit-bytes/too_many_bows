...
public class HoardedSkullEntity extends Entity {
    ...
    protected void readAdditionalSaveData(ValueInput in) {
        ...
        this.damage = in.getFloatOr("Damage", this.damage);
        this.seekRadius = in.getDoubleOr("SeekRadius", this.seekRadius);
        this.speed = in.getDoubleOr("Speed", this.speed);
        this.steering = in.getDoubleOr("Steering", this.steering);

        this.burnSeconds = in.getInt("BurnSeconds").orElse(this.burnSeconds);

        this.entityData.set(
                DATA_HOVER_DELAY,
                in.getInt("HoverDelay").orElse(this.getHoverDelay())
        );

        this.entityData.set(
                DATA_SCALE,
                in.getFloatOr("RenderScale", this.getRenderScale())
        );

        this.hitsRemaining = Math.max(
                1,
                in.getInt("HitsRemaining").orElse(this.hitsRemaining)
        );
    }
    ...
    protected void addAdditionalSaveData(ValueOutput out) {
        ...
        out.putDouble("SeekRadius", this.seekRadius);
        out.putDouble("Speed", this.speed);
        out.putDouble("Steering", this.steering);
        out.putInt("BurnSeconds", this.burnSeconds);
        out.putInt("HoverDelay", this.getHoverDelay());
        out.putFloat("RenderScale", this.getRenderScale());
        out.putInt("HitsRemaining", this.hitsRemaining);
    }

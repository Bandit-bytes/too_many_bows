...
public class GravewireArrow extends AbstractArrow {
    ...
    public GravewireArrow(EntityType<? extends AbstractArrow> entityType, Level level) {
    ...
    public GravewireArrow(Level level, LivingEntity shooter, ItemStack bowStack, ItemStack arrowStack) {
        super(EntityRegistry.GRAVEWIRE_ARROW.get(), shooter, level, bowStack, arrowStack);

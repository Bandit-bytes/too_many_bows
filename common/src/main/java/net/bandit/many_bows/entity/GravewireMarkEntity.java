...
public class GravewireMarkEntity extends Entity {
    ...
    protected void readAdditionalSaveData(CompoundTag tag) {
        ...
        this.entityData.set(DATA_INITIAL_LIFETIME, tag.getInt("InitialLifetime"));
        this.entityData.set(DATA_Y_OFFSET, tag.getFloat("YOffset"));
        this.entityData.set(DATA_RISE_AMOUNT, tag.getFloat("RiseAmount"));
    }
    ...
    protected void addAdditionalSaveData(CompoundTag tag) {
        ...
        tag.putInt("InitialLifetime", this.getInitialLifetime());
        tag.putFloat("YOffset", this.getYOffset());
        tag.putFloat("RiseAmount", this.getRiseAmount());
    }

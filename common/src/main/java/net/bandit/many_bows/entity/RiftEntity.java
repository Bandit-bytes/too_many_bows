...
public void tick() {
    ...
    private void explode() {
        ...
        if (owner instanceof Player player) {
            var dmgInst = player.getAttribute(net.minecraft.core.registries.BuiltInRegistries.ATTRIBUTE.wrapAsHolder(
                    net.bandit.many_bows.registry.AttributesRegistry.BOW_DAMAGE.get()));
            if (dmgInst != null) baseDamage *= (float) dmgInst.getValue();

            var critInst = player.getAttribute(net.minecraft.core.registries.BuiltInRegistries.ATTRIBUTE.wrapAsHolder(
                    net.bandit.many_bows.registry.AttributesRegistry.BOW_CRIT_CHANCE.get()));
